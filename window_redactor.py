...
class WindowRedactor(QMainWindow):
    ...
    def __createMainWidgets(self):
        ...
        self.primitive_panel = ObjectPanel()
        ...
        #lay = QtWidgets.QVBoxLayout(self.primitive_panel)
        #lay.addWidget(QtWidgets.QWidget())

        self.primitive_panel.objAddRequested.connect(self.work_zone.rendering_widget.add_object_from_panel)
        self.primitive_panel.show()
