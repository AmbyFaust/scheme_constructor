...
class RenderingWidget(QWidget):
    ...
    def add_primitive(self, primitive: Primitive = None, pins = None):
        if not primitive:
            primitive = Primitive('primitive', [], (0, 100), primitive_width, primitive_height)
    ...
    def add_block(self, block: Block = None, pins = None):
        if not block:
            block = Block('block', [], [], [], (0, 0), block_width, block_height)
