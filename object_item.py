...
# создаЄт начальный примитив, добавл€емый в список при инициализации
...
#    singledispatchmethod отказываетс€ работать, поэтому статик
#    вспомогательный класс клонировани€ виджетов
#
#    !! ” созданного клона родитель объекта устанавливаетс€ None !!
#    !! –одителем всех пинов €вл€етс€ клон                       !!
#    !!  оординаты пинов задаютс€ в локальной системе координат  !!
#    !! Ёто важно учитывать при получении пинов                  !!
