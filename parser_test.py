...
class TestJsonParsing(unittest.TestCase):
    ...
    def test_parse_block(self):
        data = {"type": "block", "name": "valid_block", "top_left": (0, 0), "width": 30, "height": 50, "pins": [{"name": "pin2", "top_left": (2, 2)}], "objects": [{"type": "primitive", "name": "valid_inner_primitive", "top_left": (1, 1), "width": 15, "height": 25, "pins": [{"name": "pin3", "top_left": (3, 3)}]}], "pin_nets": [{"name": "pin_net1", "pins": {"pins": ["pin2"]}, "lines": [[(0, 0), (1, 1)]]}]}
        result = parse_block(data)
        self.assertIsInstance(result, Block)

    def test_parse_object(self):
        data = {"type": "primitive", "name": "valid_primitive", "top_left": (0, 0), "width": 10, "height": 20}
        result = parse_object(data)
        self.assertIsInstance(result, Object)

    def test_parse_objects(self):
        data = {"objects": [{"type": "primitive", "name": "valid_primitive", "top_left": (0, 0), "width": 10, "height": 20}]}
